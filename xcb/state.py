...
class Module(object):
    ...
    def __init__(self, filename, output):
        ...
        self.add_type('CARD8',  '', tcard8.name,  tcard8)
        self.add_type('CARD16', '', tcard16.name, tcard16)
        self.add_type('CARD32', '', tcard32.name, tcard32)
        self.add_type('INT8',   '', tint8.name,   tint8)
        self.add_type('INT16',  '', tint16.name,  tint16)
        self.add_type('INT32',  '', tint32.name,  tint32)
        self.add_type('BYTE',   '', tcard8.name,  tcard8)
        self.add_type('BOOL',   '', tcard8.name,  tcard8)
        self.add_type('char',   '', tchar.name,   tchar)
        self.add_type('float',  '', tfloat.name,  tfloat)
        self.add_type('double', '', tdouble.name, tdouble)
        self.add_type('void',   '', tcard8.name,  tcard8)

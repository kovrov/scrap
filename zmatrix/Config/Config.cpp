...
//
//  Program:   ZMatrix
//  Module:    $RCSfile: Config.cpp,v $
//  Language:  C/C++
//  Date:      $Date: 2003/05/10 17:06:21 $
...
//---------------------------------------------------------------------------
USEFORM("ConfigForm.cpp", ConfigurationForm);
USEFORM("CharSetForm.cpp", CharacterSetForm);
USEFORM("AboutUnit.cpp", AboutForm);
USEFORM("HireUnit.cpp", HireForm);
//---------------------------------------------------------------------------

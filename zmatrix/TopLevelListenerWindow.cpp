...
//===========================================================================
LRESULT CALLBACK
TopLevelListenerWindowProc(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
...
void CreateTopLevelListener(void)
{
	...
	TopLevelListenerWindow = ::CreateWindow(
				ListenerClassName, _TEXT("Matrix Code Listener"), 0,
				0, 0, 0, 0, ::GetDesktopWindow(), NULL, ghInstance, NULL);

glib-genmarshal --prefix _clock_marshal --header clock-marshallers.list > clock-marshallers.h
glib-genmarshal --prefix _clock_marshal --body clock-marshallers.list > clock-marshallers.c
...
gcc -g -o clock clock.c main.c clock-marshallers.c %CFLAGS% %LDFLAGS% -mwindows
